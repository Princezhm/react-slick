          ...
          return (
            ...
            (t.prototype.render = function() {
                ...
                ? ((t = this.props.responsive.filter(function(e) {
                  ...
                  (e =
                    "unslick" === t[0].settings
                      ? "unslick"
                      : a({}, h.default, this.props, t[0].settings)))
                : (e = a({}, h.default, this.props)),
                e.centerMode &&
                  (e.slidesToScroll > 1 &&
                    console.warn(
              ...
              for (
                ...
                for (
                  ...
                  for (
                    ...
                    (e.variableWidth &&
                      r[v].props.style &&
                      (o = r[v].props.style.width),
                    !(v >= r.length));
                    v += 1
                  )
                    f.push(
                      c.default.cloneElement(r[v], {
                        key: void 0 !== d ? d : 100 * s + 10 * p + v,
                        tabIndex: -1,
                        style: {
                ...
                e.variableWidth
                  ? i.push(
                      c.default.createElement(
                        "div",
                        { key: void 0 !== d ? d : s, style: { width: o } },
                        l
                      )
                    )
                  : i.push(
              ...
              if ("unslick" === e) {
                ...
                return c.default.createElement("div", { className: y }, i);
              }
              return (
          ...
          return (
            ...
            (r.adaptHeight = function() {
              if (r.props.adaptiveHeight && r.list) {
                ...
                r.list.style.height = (0, m.getHeight)(e) + "px";
              }
            }),
            (r.componentWillMount = function() {
              if (
                ...
                var e = (0, m.getOnDemandLazySlides)(c({}, r.props, r.state));
                e.length > 0 &&
            ...
            (r.componentWillReceiveProps = function(e) {
              ...
              r.updateState(t, n, function() {
                r.state.currentSlide >= d.default.Children.count(e.children) &&
                  r.changeSlide({
                    message: "index",
                    index:
                      d.default.Children.count(e.children) - e.slidesToShow,
            ...
            (r.resizeWindow = function() {
              var e =
                ...
                arguments[0];
              if (f.default.findDOMNode(r.track)) {
                var t = c(
            ...
            (r.updateState = function(e, t, n) {
              var i = (0, m.initializedState)(e);
              e = c({}, e, i, { slideIndex: i.currentSlide });
              var o = (0, m.getTrackLeft)(e);
              e = c({}, e, { left: o });
              var s = (0, m.getTrackCSS)(e);
              (t ||
                d.default.Children.count(r.props.children) !==
                  d.default.Children.count(e.children)) &&
                (i.trackStyle = s),
                r.setState(i, n);
            }),
            (r.ssrInit = function() {
              if (r.props.variableWidth) {
                ...
                for (var a = 0; a < o; a++) e += n[a];
                for (var l = 0; l < r.state.currentSlide; l++) t += n[l];
                var u = { width: e + "px", left: -t + "px" };
                if (r.props.centerMode) {
                  var p = n[r.state.currentSlide] + "px";
                  u.left = "calc(" + u.left + " + (100% - " + p + ") / 2 ) ";
                }
                return void r.setState({ trackStyle: u });
              }
              var f = d.default.Children.count(r.props.children),
                h = c({}, r.props, r.state, { slideCount: f }),
                v = (0, m.getPreClones)(h) + (0, m.getPostClones)(h) + f,
                y = (100 / r.props.slidesToShow) * v,
                g = 100 / v,
                S =
                  (-g * ((0, m.getPreClones)(h) + r.state.currentSlide) * y) /
                  100;
              r.props.centerMode && (S += (100 - (g * y) / 100) / 2);
              var w = { width: y + "%", left: S + "%" };
              r.setState({ slideWidth: g + "%", trackStyle: w });
            }),
            ...
            (r.progressiveLazyLoad = function() {
              for (
                ...
                n < r.state.slideCount + (0, m.getPostClones)(t);
                n++
              )
              ...
              for (
                var i = r.state.currentSlide - 1;
                i >= -(0, m.getPreClones)(t);
                i--
              )
                if (r.state.lazyLoadedList.indexOf(i) < 0) {
                  e.push(i);
                  break;
                }
              e.length > 0
              ...
              if (f) {
                ...
                l && v.length > 0 && l(v),
                  r.setState(f, function() {
                    o &&
                      o.innerSlider.state.currentSlide !== s &&
            ...
            (r.changeSlide = function(e) {
              var t =
                  ...
                  arguments[1],
                n = c({}, r.props, r.state),
                i = (0, m.changeSlide)(n, e);
              (0 === i || i) &&
                (t === !0 ? r.slideHandler(i, t) : r.slideHandler(i));
            }),
            (r.clickHandler = function(e) {
              r.clickable === !1 && (e.stopPropagation(), e.preventDefault()),
                (r.clickable = !0);
            }),
            (r.keyHandler = function(e) {
              var t = (0, m.keyHandler)(e, r.props.accessibility, r.props.rtl);
            ...
            (r.swipeStart = function(e) {
              ...
              var t = (0, m.swipeStart)(e, r.props.swipe, r.props.draggable);
              "" !== t && r.setState(t);
            }),
            ...
            (r.play = function() {
              ...
              if (r.props.rtl)
                ...
                if (!(0, m.canGoNext)(c({}, r.props, r.state))) return !1;
                e = r.state.currentSlide + r.props.slidesToScroll;
              }
              r.slideHandler(e);
            }),
            ...
            (r.render = function() {
              var e = (0, w.default)("slick-slider", r.props.className, {
                  "slick-vertical": r.props.vertical,
                  "slick-initialized": !0
                }),
                t = c({}, r.props, r.state),
                n = (0, m.extractObject)(t, [
                  "fade",
                  "cssEase",
                  "speed",
                  "infinite",
                ...
                i = r.props.pauseOnHover;
              n = c({}, n, {
                onMouseEnter: i ? r.onTrackOver : null,
                onMouseLeave: i ? r.onTrackLeave : null,
                onMouseOver: i ? r.onTrackOver : null,
              ...
              if (
                ...
                var s = (0, m.extractObject)(t, [
                  ...
                  a = r.props.pauseOnDotsHover;
                (s = c({}, s, {
                  clickHandler: r.changeSlide,
                  onMouseEnter: a ? r.onDotsLeave : null,
                  onMouseOver: a ? r.onDotsOver : null,
                  onMouseLeave: a ? r.onDotsLeave : null
                })),
                  (o = d.default.createElement(k.Dots, s));
              }
              var l,
                u,
                p = (0, m.extractObject)(t, [
                  "infinite",
                  "centerMode",
                  "currentSlide",
                  "slideCount",
              ...
              (p.clickHandler = r.changeSlide),
                r.props.arrows &&
                  ((l = d.default.createElement(T.PrevArrow, p)),
                  (u = d.default.createElement(T.NextArrow, p)));
              var f = null;
              ...
              var v = c({}, f, h),
                ...
                S = { className: e, dir: "ltr" };
              return (
                r.props.unslick &&
                  ((g = { className: "slick-list" }), (S = { className: e })),
            ...
            (r.state = c({}, v.default, {
              ...
              slideCount: d.default.Children.count(r.props.children)
            })),
            (r.callbackTimers = []),
            (r.clickable = !0),
      ...
      (function(t) {
        function n(e, t, n) {
          function i(t) {
            var n = v,
              r = y;
            return (v = y = void 0), (O = t), (S = e.apply(r, n));
          }
          function o(e) {
            return (O = e), (w = setTimeout(u, t)), _ ? i(e) : S;
          }
          function l(e) {
            var n = e - T,
              r = e - O,
          ...
          function c(e) {
            var n = e - T,
              r = e - O;
            return void 0 === T || n >= t || n < 0 || (x && r >= g);
          }
          function u() {
            var e = k();
            return c(e) ? d(e) : void (w = setTimeout(u, l(e)));
          }
          function d(e) {
            return (w = void 0), E && v ? i(e) : ((v = y = void 0), S);
          }
          function p() {
            void 0 !== w && clearTimeout(w), (O = 0), (v = T = y = w = void 0);
          }
          function f() {
            return void 0 === w ? S : d(k());
          }
          function h() {
            var e = k(),
              n = c(e);
            if (((v = arguments), (y = this), (T = e), n)) {
              if (void 0 === w) return o(T);
              if (x) return (w = setTimeout(u, t)), i(T);
            }
            return void 0 === w && (w = setTimeout(u, t)), S;
          }
          var v,
            y,
            g,
        ...
        function o(e) {
          return "symbol" == typeof e || (i(e) && w.call(e) == c);
        }
        function s(e) {
	...
	*/
    ...
    function(e, t, n) {
      ...
      var i =
        ...
        u = ((t.getRequiredLazySlides = function(e) {
        ...
        (t.initializedState = function(e) {
          var t = s.default.Children.count(e.children),
            n = Math.ceil(h(l.default.findDOMNode(e.listRef))),
            r = Math.ceil(h(l.default.findDOMNode(e.trackRef))),
            i = void 0;
          if (e.vertical) i = n;
          else {
            ...
            "string" == typeof e.centerPadding &&
              ...
              (o *= n / 100),
              (i = Math.ceil((n - o) / e.slidesToShow));
          }
          var a =
              l.default.findDOMNode(e.listRef) &&
              v(
                l.default
          ...
          var p = e.lazyLoadedList || [],
            f = c({ currentSlide: d, lazyLoadedList: p }, e);
          p.concat(f);
          var y = {
            slideCount: t,
            slideWidth: i,
        ...
        (t.slideHandler = function(e) {
          ...
          if (r) {
            if (!o && (s < 0 || s >= a)) return {};
            s < 0 ? (y = s + a) : s >= a && (y = s - a),
              u && l.indexOf(y) < 0 && l.push(y),
              (b = { animating: !0, currentSlide: y, lazyLoadedList: l }),
              (_ = { animating: !1 });
          } else
            (S = y),
              y < 0
                ? ((S = y + a), o ? a % f !== 0 && (S = a - (a % f)) : (S = 0))
                : !g(e) && y > d
                  ? (y = S = d)
                  : p && y >= a
                    ? ((y = o ? a : a - 1), (S = o ? 0 : a - 1))
                    : y >= a &&
                      ((S = y - a), o ? a % f !== 0 && (S = 0) : (S = a - h)),
              (w = O(i({}, e, { slideIndex: y }))),
              (m = O(i({}, e, { slideIndex: S }))),
              o || (w === m && (y = S), (w = m)),
              u && l.concat(c(i({}, e, { currentSlide: y }))),
              v
                ? ((b = {
                    animating: !0,
                    currentSlide: S,
                    trackStyle: T(i({}, e, { left: w })),
                    lazyLoadedList: l
                  }),
                  (_ = {
                    animating: !1,
                    currentSlide: S,
                    trackStyle: k(i({}, e, { left: m })),
                    swipeLeft: null
                  }))
                : (b = {
                    currentSlide: S,
        ...
        (t.changeSlide = function(e, t) {
          ...
          if (
            ...
            (o = 0 === n ? l : c - n),
              (a = d - o),
              p && !f && ((r = d - o), (a = r === -1 ? u - 1 : r));
          else if ("next" === t.message)
            (o = 0 === n ? l : n),
              (a = d + o),
              p && !f && (a = ((d + l) % u) + n);
          else if ("dots" === t.message) {
            if (((a = t.index * t.slidesToScroll), a === t.currentSlide))
              return null;
          } else if ("children" === t.message) {
            if (((a = t.index), a === t.currentSlide)) return null;
            if (f) {
              var h = M(i({}, e, { targetSlide: a }));
            ...
            "index" === t.message &&
            ((a = Number(t.index)), a === t.currentSlide)
          )
            return null;
          return a;
        }),
        ...
        (t.swipeMove = function(e, t) {
          ...
          if (!n) {
            ...
            var L = Math.round(Math.sqrt(Math.pow(m.curY - m.startY, 2)));
            if (!a && !h && L > 10) return { scrolling: !0 };
            a && (m.swipeLength = L);
            var C = (l ? -1 : 1) * (m.curX > m.startX ? 1 : -1);
            a && (C = m.curY > m.startY ? 1 : -1);
            var z = Math.ceil(v / S),
              P = y(t.touchObject, a),
              H = m.swipeLength;
            return (
              w ||
                (((0 === c && "right" === P) ||
                  ...
                  (!g(t) && "left" === P)) &&
                  ((H = m.swipeLength * u),
                  d === !1 && p && (p(P), (E.edgeDragged = !0)))),
              !f && b && (b(P), (E.swiped = !0)),
              (x = o ? M + H * (T / _) * C : l ? M - H * C : M + H * C),
              a && (x = M + H * C),
              (E = i({}, E, {
                touchObject: m,
                swipeLeft: x,
                trackStyle: k(i({}, t, { left: x }))
              })),
              Math.abs(m.curX - m.startX) < 0.8 * Math.abs(m.curY - m.startY)
                ? E
                : (m.swipeLength > 10 && ((E.swiping = !0), e.preventDefault()),
                  E)
            );
          }
        }),
        (t.swipeEnd = function(e, t) {
          ...
          if (o.swipeLength > h) {
            e.preventDefault(), f && f(v);
            var S = void 0,
              b = void 0;
            switch (v) {
              case "left":
              case "up":
                (b = u + m(t)), (S = d ? w(t, b) : b), (g.currentDirection = 0);
                break;
              case "right":
              case "down":
                (b = u - m(t)), (S = d ? w(t, b) : b), (g.currentDirection = 1);
                break;
              default:
                S = u;
            }
            g.triggerSlideHandler = S;
          } else {
            var k = O(t);
            g.trackStyle = T(i({}, t, { left: k }));
          }
          return g;
        }),
        ...
        m = (t.getSlideCount = function(e) {
          ...
          if (e.swipeToSlide) {
            var n = void 0,
              r = l.default.findDOMNode(e.listRef),
              i = r.querySelectorAll(".slick-slide");
            if (
              (Array.from(i).every(function(r) {
                if (e.vertical) {
                  if (r.offsetTop + v(r) / 2 > e.swipeLeft * -1)
                    return (n = r), !1;
                } else if (r.offsetLeft - t + h(r) / 2 > e.swipeLeft * -1) return (n = r), !1;
                return !0;
              }),
              !n)
            )
              return 0;
            var o =
                e.rtl === !0 ? e.slideCount - e.currentSlide : e.currentSlide,
              s = Math.abs(n.dataset.index - o) || 1;
            return s;
          }
        ...
        k = (t.getTrackCSS = function(e) {
          ...
          if (e.useTransform) {
            ...
            o = i({}, o, { WebkitTransform: s, transform: a, msTransform: l });
        ...
        O = (t.getTrackLeft = function(e) {
          ...
          if (
            ...
            if (
              ...
              (m = o ? r + _(e) : r), (n = k && k.children[m]), (t = 0);
              for (var T = 0; T < m; T++)
                t -= k && k.children[T] && k.children[T].offsetWidth;
    ...
    function(e, t, n) {
      ...
      var a =
        ...
        h = function(e) {
          var t = {};
          return (
            (void 0 !== e.variableWidth && e.variableWidth !== !1) ||
        ...
        y = function(e) {
          var t,
            ...
            r = [],
            i = [],
            o = c.default.Children.count(e.children),
            s = (0, p.lazyStartIndex)(e),
            l = (0, p.lazyEndIndex)(e);
          return (
            c.default.Children.forEach(e.children, function(u, y) {
              var g = void 0,
                S = {
                  message: "children",
                  index: y,
              ...
              if (
                (n.push(
                  c.default.cloneElement(g, {
                    key: "original" + v(g, y),
                    "data-index": y,
                    className: (0, d.default)(b, m),
                    tabIndex: "-1",
                    "aria-hidden": !b["slick-active"],
                    style: a({ outline: "none" }, g.props.style || {}, w),
                    onClick: function(t) {
                      g.props && g.props.onClick && g.props.onClick(t),
                        e.focusOnSelect && e.focusOnSelect(S);
                    }
                  })
                ),
                e.infinite && e.fade === !1)
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e = y(this.props),
              ...
              r = t.onMouseOver,
              i = t.onMouseLeave,
              o = { onMouseEnter: n, onMouseOver: r, onMouseLeave: i };
            return c.default.createElement(
              "div",
              a({ className: "slick-track", style: this.props.trackStyle }, o),
              e
            );
          }),
          t
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e = this,
              ...
              i = n.onMouseOver,
              o = n.onMouseLeave,
              s = { onMouseEnter: r, onMouseOver: i, onMouseLeave: o },
              l = Array.apply(
                null,
                Array(t + 1)
                  .join("0")
                ...
                var r = n * e.props.slidesToScroll,
                  ...
                  o = (0, d.default)({
                    "slick-active":
                      e.props.currentSlide >= r && e.props.currentSlide <= i
                  }),
                  s = {
                    message: "dots",
                    index: n,
            ...
            return c.default.cloneElement(
              ...
              a({ className: this.props.dotsClass }, s)
            );
          }),
          t
        );
        ...
        return (
          ...
          (t.prototype.render = function() {
            ...
            var n = {
              ...
              i = void 0;
            return (i = this.props.prevArrow
              ? c.default.cloneElement(this.props.prevArrow, a({}, n, r))
              : c.default.createElement(
                  "button",
          ...
          return (
            ...
            (t.prototype.render = function() {
              ...
              var n = {
                ...
                i = void 0;
              return (i = this.props.nextArrow
                ? c.default.cloneElement(this.props.nextArrow, a({}, n, r))
                : c.default.createElement(
                    "button",
    ...
    function(e, t, n) {
      (function(t) {
        !(function(t, n) {
          ...
          function r(t) {
            for (
              var n = ["top", "right", "bottom", "left"], r = {}, i = 0, o = n;
              i < o.length;
              i += 1
            ) {
              var s = o[i],
          ...
          function o(t) {
            ...
            if (
              ("border-box" === a.boxSizing &&
                (Math.round(p + u) !== i && (p -= n(a, "left", "right") + u),
                Math.round(f + d) !== o && (f -= n(a, "top", "bottom") + d)),
              !s(t))
            ) {
              var h = Math.round(p + u) - i,
                v = Math.round(f + d) - o;
              1 !== Math.abs(h) && (p -= h), 1 !== Math.abs(v) && (f -= v);
            }
            return c(l.left, l.top, p, f);
          }
          function s(e) {
            return e === b(e).document.documentElement;
          }
          function a(e) {
            return d ? (T(e) ? i(e) : o(e)) : k;
          }
          function l(e) {
            var t = e.x,
              n = e.y,
          ...
          var u = (function() {
            ...
            w = function() {
              (this.connected_ = !1),
                ...
                (this.refresh = v(this.refresh.bind(this), y));
            };
          (w.prototype.addObserver = function(e) {
            ...
            (w.getInstance = function() {
              return (
                this.instance_ || (this.instance_ = new w()), this.instance_
              );
            }),
            (w.instance_ = null);
          var m = function(e, t) {
          ...
          var E = "undefined" != typeof WeakMap ? new WeakMap() : new u(),
            M = function(e) {
          ...
          var L = (function() {
            return "undefined" != typeof p.ResizeObserver
              ? p.ResizeObserver
              : M;
          })();
          return L;
